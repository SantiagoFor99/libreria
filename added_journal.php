...
$idjour=$_POST['id_journal'];
$namejour=$_POST['name_journal'];
$urljour=$_POST['url'];
$idedi=$_POST['id_editorial'];
$verify = "select * from journals where name_journal='$namejour'";
$veri= mysqli_query($conexion, $verify);
if($veri){echo '<script> alert("La revista libro ya esta registrada");</script>';
    echo '<script> window.location="add_gender.html"; </script>';}else{
    $consulta = "insert into journal(id_journal,name_journal,url,id_editorial) values ('$idjour','$namejour','$urljour','$idedi')" ;
}
echo "<br>";
$datos = mysqli_query($conexion, $consulta);
if ($consulta) {
    echo 'Registro Exitoso';
    echo "<br><td><a href='conn_journal.php'>Go consultations</a></td><br>";
    echo "<td><a href='index_loger.php'>at the beginning</a></td><br>";
} else {
