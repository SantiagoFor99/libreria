...
$consulta = "select * from audiobooks";
$datos = mysqli_query($conexion, $consulta);


echo "<table border='solid'>";
echo "<tr><td>Id Audiolibro</td><td>Nombre</td><td>Url</td><td></td><td></td></tr>";
while ($row = mysqli_fetch_array($datos)) {
    echo '<tr>';
    echo "<td>" . $row['id_audiobook'] . "</td>";
    echo "<td>" . $row['name_audiobook'] . "</td>";
    echo "<td><a href=".$row['url_audiobook'].">URL</a></td>";
    echo "<td><a href='changes_a.php?codaudio=".$row['id_audiobook']."'>Cambiar</a></td>";
	echo "<td><a href='drop_audio.php?codaudio=".$row['id_audiobook']."'>Eliminar</a></td>";
