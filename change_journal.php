...
$consulta = "select * from journals";
$datos = mysqli_query($conexion, $consulta);


echo "<table border='solid'>";
echo "<tr><td>Id Revista</td><td>Nombre</td><td>Url</td><td>Id Editorial</td></tr>";
while ($row = mysqli_fetch_array($datos)) {
    echo '<tr>';
    echo "<td>" . $row['id_journal'] . "</td>";
    echo "<td>" . $row['name_journal'] . "</td>";
    echo "<td><a href=".$row['url'].">URL</a></td>";
    echo "<td>" . $row['id_editorial'] . "</td>";
    echo "<td><a href='changes_j.php?codjour=".$row['id_journal']."'>Cambiar</a></td>";
	echo "<td><a href='drop_journal.php?codjour=".$row['id_journal']."'>Eliminar</a></td>";
}
