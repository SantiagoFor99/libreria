...
Si eres un lector apasionado estás en el lugar correcto.</p>
							...
							<!-- Section -->
								<section>
									<center><h1>Cambiar Datos Audiolibro </h1></center>    
<h3>Requerido *</h3> 
<form  action ="new_audio.php" method="post">
        <center><label>Id Audiolibro: </label><input type="text"  name="id_audiobook" value="<?php echo $_GET['codaudio']; ?>"></center><br>
        <center><label>Nombre Audiolibro: *</label><input type="text" name="name_audiobook" required=""></center><br>
        <center><label>Url: *</label><input type="text" name="url_audiobook" required=""></center><br>
