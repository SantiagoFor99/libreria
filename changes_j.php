...
Si eres un lector apasionado estás en el lugar correcto.</p>
							...
							<!-- Section -->
								<section>
									<center><h1>Cambiar Datos Revista</h1></center>  
<h3>Requerido *</h3>                                                                        
    <form  action ="new_journal.php" method="post">
        <center><label>Id Revista: </label><input type="text"  name="id_journal" value="<?php echo $_GET['codjour']; ?>"></center><br>
        <center><label>Nombre Revista: *</label><input type="text" name="name_journal" required=""></center><br>
