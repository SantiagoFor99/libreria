...
Si eres un lector apasionado estás en el lugar correcto.</p>
							...
							<!-- Section -->
								<section>
									<?php
        $idad=$_POST['id_audiobook'];
        $namead=$_POST['name_audiobook'];
        $urlad=$_POST['url_audiobook'];
        $id_book=27;
        ...
        $consulta = "update audiobooks set name_audiobook = '$namead' , url_audiobook = '$urlad' , id_book = $id_book  where id_audiobook = $idad" ;
